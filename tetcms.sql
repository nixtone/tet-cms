...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 14 2023 г., 17:50
...
CREATE TABLE `url` (
  ...
  `SECTION_BLOCK` int NOT NULL DEFAULT '0',
...
INSERT INTO `url` (`ID`, `URL`, `SECTION`, `SECTION_BLOCK`, `ELEMENT`) VALUES
(1, '/katalog/elektro/lampochka-svetit', 3, 1, 1),
(2, '/', 1, 0, 0);
